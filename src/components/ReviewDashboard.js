          ...
          <div className="body-container">
            ...
            <div className="list-view-section">
              <span className="list-view-textD">
                LIST VIEW ({filteredMatches.length})
              </span>
            </div>
              {/* vikas   put content here    */}
              <ReviewPageCard color={color[0]}/>    
              <ReviewPageCard color={color[1]}/> 
              <ReviewPageCard color={color[2]}/> 
              <ReviewPageCard color={color[3]}/> 
              <ReviewPageCard color={color[4]}/> 
              <ReviewPageCard color={color[5]}/>   
            {/* Pagination Controls */}
